  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-60 -right-40 w-[600px] h-[600px] rounded-full bg-amber-600/7 blur-[140px]" />
      </div>
      ...
      <div className="w-full max-w-[380px] relative z-10">
        ...
        <div className="water-glass relative overflow-hidden" style={{ padding: '2rem' }}>
          ...
          <div className="absolute top-0 left-0 right-0 h-px"
            style={{ background: 'linear-gradient(90deg, transparent, rgba(245,158,11,0.6) 40%, rgba(217,119,6,0.5) 60%, transparent)' }} />
