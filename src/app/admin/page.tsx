...
const PLAN_COLORS: Record<string, string> = {
  BASIC: 'text-amber-400 bg-amber-500/10 border-amber-500/20',
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-xs text-white/30 mt-0.5">Panel de administración Nexor</p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div className="bg-white/[0.025] border border-white/8 rounded-2xl overflow-hidden">
          <div className="flex items-center justify-between px-4 py-3 border-b border-white/5">
            ...
            <Link href="/admin/purchases" className="text-[10px] text-amber-400 hover:text-amber-300 flex items-center gap-1">
        ...
        <div className="bg-white/[0.025] border border-white/8 rounded-2xl overflow-hidden">
          <div className="flex items-center justify-between px-4 py-3 border-b border-white/5">
            ...
            <Link href="/admin/withdrawals" className="text-[10px] text-amber-400 hover:text-amber-300 flex items-center gap-1">
              Ver todo <ArrowRight size={10} />
            </Link>
          </div>
