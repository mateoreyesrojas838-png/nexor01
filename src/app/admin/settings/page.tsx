    ...
    <div className="space-y-6 max-w-xl">
      ...
      {loading ? (
        ...
        <>
          ...
          {/* Métodos de pago */}
          <div className="space-y-3">
            <p className="text-[10px] font-black uppercase tracking-widest text-white/30">Método de Pago</p>
            <div className="bg-white/[0.025] border border-white/8 rounded-2xl p-4 space-y-4">
              <p className="text-xs text-white/40">El método de pago es exclusivamente por comprobante QR. El admin verifica y aprueba manualmente.</p>
