  ...
  const sections = [
    {
      ...
      items: [
        { icon: Shield, label: 'Seguridad',    sub: 'Contraseña y 2FA',       color: '#FFD700' },
        { icon: Globe,  label: 'Idioma',       sub: 'Español (ES)',            color: '#B45309' },
      ]
    },
    {
      title: 'Preferencias',
  ...
  return (
    <div className="px-4 sm:px-6 pt-6 max-w-4xl mx-auto pb-20 space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-xs font-light tracking-widest mt-0.5" style={{ color: 'rgba(255,255,255,0.3)' }}>
            Personaliza tu experiencia en NEXOR
          </p>
        </div>
      </div>
      ...
      <p className="text-center text-[10px] font-light" style={{ color: 'rgba(255,255,255,0.12)' }}>
        NEXOR © 2026 &bull; Build 20260217
      </p>
    </div>
  )
}
