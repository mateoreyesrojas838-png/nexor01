...
const PACKS = [
  { id: 'basic', planId: 'BASIC', name: 'Pack Básico', tagline: 'Empieza a vender con un agente AI', icon: Zap, featured: false },
  { id: 'pro', planId: 'PRO', name: 'Pack Pro', tagline: 'Escala tus ventas y anuncios sin límites', icon: Sparkles, featured: true },
  { id: 'elite', planId: 'ELITE', name: 'Pack Elite', tagline: 'El máximo poder para líderes de negocio', icon: Crown, featured: false },
]
